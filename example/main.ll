...
@.str = private unnamed_addr constant [11 x i8] c"Trap hit!\0A\00", align 1
@stack = common global i64 0, align 8
@.str.1 = private unnamed_addr constant [14 x i8] c"stack: 0x%lx\0A\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable
define void @_trap() #0 {
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0))
...
define i32 @main() #0 {
  ...
  %2 = call i8* @"\01_mmap"(i8* null, i64 4096, i32 3, i32 4098, i32 -1, i64 0)
  %3 = ptrtoint i8* %2 to i64
  store i64 %3, i64* @stack, align 8
  %4 = load i64, i64* @stack, align 8
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0), i64 %4)
  call void bitcast (void (...)* @__lifter_init to void ()*)()
  %6 = call i64 bitcast (i64 (...)* @_main to i64 ()*)()
  ret i32 0
}

declare i8* @"\01_mmap"(i8*, i64, i32, i32, i32, i64) #1
